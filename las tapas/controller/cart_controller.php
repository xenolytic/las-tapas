...
if (isset($_POST['proceed'])) {
    ...
    $copy_sql = "INSERT INTO completed_orders (item_name, item_price, quantity)
                 SELECT item_name, item_price, quantity FROM orders";
...
$sql = "SELECT id, item_name, item_price, quantity FROM orders"; // Include the quantity column
